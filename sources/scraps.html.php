<div id="stickerPanel" class="card mt-3">
	<header class="card-header">
		...
		<button class="card-header-icon card-toggle">
			<span class="icon">
				<img src="../public/icons/MaterialIcons/icons8-expand-arrow-48.png" alt="Options" title="More Options">
			</span>
		</button>
	</header>
	...
	<div class="card-content">
		<div class="content">
			<figure>
				<img src="../public/stickers/bolt.png" class="sticker frame is-white p-5 is-clickable" id="img1"
					alt="bolt">
				<img src="../public/stickers/stealie.png" class="sticker frame is-white p-5 is-clickable" id="img2"
					alt="stealie">

				<img src="../public/stickers/stealieBlank.png" class="sticker frame is-white p-5 is-clickable" id="img3"
					alt="stealieBlank">
				<img src="../public/stickers/silent.png" class="sticker frame is-white p-5 is-clickable" id="img4"
					alt="stealie">
			</figure>
		</div>
	</div>
	...
	<div class="card-content" id="stickerList">
		<div class="tile is-ancestor">
			<div class="tile is-parent">
				<div class="tile is-child is-1">
					<figure class="image is-128x128">
						<img src="../public/stickers/bolt.png" class="button sticker frame is-white" id="img1"
							alt="bolt">
					</figure>
				</div>
			</div>
			<div class="tile is-parent">
				<div class="tile is-child is-1">
					<figure class="image is-128x128">
						<img src="../public/stickers/stealie.png" class="button sticker frame is-white" id="img2"
							alt="stealie">
					</figure>
				</div>
			</div>
		...
		<div class="tile is-ancestor">
			<div class="tile is-parent">
				<div class="tile is-child is-1">
					<figure class="image is-128x128">
						<img src="../public/stickers/stealieBlank.png" class="button sticker frame is-white" id="img3"
							alt="stealieBlank">
					</figure>
				</div>
			</div>
			<div class="tile is-parent">
				<div class="tile is-child is-1">
					<figure class="image is-128x128">
						<img src="../public/stickers/silent.png" class="button sticker frame is-white" id="img4"
							alt="stealie">
					</figure>
				</div>
			</div>
...
<div id="webcamCard" class="card mt-2">
	<div class="block has-text-centered" id="captureImage">
		<header class="card-header">
			...
			<button class="card-header-icon card-toggle">
				<span class="icon">
					<img src="../public/icons/MaterialIcons/icons8-expand-arrow-48.png" alt="Open" title="Camera View">
				</span>
			</button>
		</header>
	...
	<div class="card-content is-hidden" id="libraryList">
		<div class="tile is-ancestor">
			...
			<div class="tile is-parent">
				<div class="tile is-child is-1">
					<figure class="image is-128x128">
						<img src="../public/stickers/stealie.png" class="button frame is-white" id="camagru">
					</figure>
				</div>
			</div>
		</div>
