...
<div class="home-top-nav">
	...
	<div class="home-top-nav-icon">
		<div class="home-top-nav-logo">
			<a href="home.php">
				<img src="../media/logos/Camagru-logos_sideBySide_black.png" alt="Camagru logo" />
			</a>
		</div>
	</div>
	...
	<div class="home-top-nav-icon">
		<div class="home-top-nav-icon-inside">
			...
			<div class="home-top-nav-icons">
				<a class="outline" href="../srcs/profile-page.php"><img
						...
						alt="profile image icon" /></a>
			</div>

			<div class="home-top-nav-icons">
				<a class="outline" href="editing-page.php"><img id="editing"
			...
			<div class="home-top-nav-icons">
				<a class="outline" href="settings.php"><img id="settings"
						src="../media/icons/icons8-settings-outline.png"
						onmouseover="this.src='../media/icons/icons8-settings-inline.png'"
						onmouseout="this.src='../media/icons/icons8-settings-outline.png'" alt="camera image icon" />
				</a>
			</div>
