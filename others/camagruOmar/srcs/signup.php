				...
				number and length of 8" . "<h6>";
					...
					$message = "<h6 id='message'>" . "username already exist" . "<h6>";
							...
							$message = "<h6 id='message'>" . "please fill all the fields" . "<h6>";
									...
									$insert_q = $dbh->prepare("INSERT INTO `user_verify` (`fullname`, `username`,
									`email`, `password`, `code`)
									...
									$body = "Your activation code is: " . $code . ". Please enter your code in the
									verification page";
									...
									<body>
										<img id="main-logo" src="../media/logos/Camagru-logos_textAndCat2_black.png"
											alt="">
										...
										<div class="credentials-container">
											...
											<div class="instagram-container">
												...
												<div class="instagram-logo">
													<img src="../media/logos/Camagru-logos_sideBySide_black.png"
														alt="brand logo">
												</div>
													...
													<div class="instagram-container-inside">
														...
														<div class="input-block">
															...
															<input type="email" name="email"
																onfocus="focusSpan('espan')"
																onfocusout="focusOut('espan')" required>
														</div>
														<div class="input-block">
															<span id="fspan">Full name</span>
															<input type="text" name="fullname"
																onfocus="focusSpan('fspan')"
																onfocusout="focusOut('fspan')" required>
														</div>
														<div class="input-block">
															<span id="uspan">Username</span>
															<input type="text" name="username"
																onfocus="focusSpan('uspan')"
																onfocusout="focusOut('uspan')" required>
														</div>
														<div class="input-block">
															<span id="pspan">Password</span>
															<input type="password" name="password"
																onfocus="focusSpan('pspan')"
																onfocusout="focusOut('pspan')" required>
														</div>
