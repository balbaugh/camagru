				...
				<div class="form-container">
					<div class="form-content box">
						...
						<form class="login-form" id="signup-form" action="process_signup.php" method="POST"
							...
							<p id="error_message" class="text-center alert alert-danger">
							...
							<div class="form-group">
								<div class="login-input">
									<input type="text" name="username" placeholder="Type your username..." required
										pattern="^[a-zA-Z0-9]+$" title="Only letters and numbers, max length 20"
										maxlength="20">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="btn-group">
								<button class="login-btn" name="signup_btn" id="signup_btn" type="submit">Sign
									Up</button>
							</div>
						</form>
						<div class="or">
